...
export class init1673420688787 implements MigrationInterface {
    name = 'init1673420688787'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`phone_number\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`status\` int NOT NULL, \`gender\` tinyint NOT NULL, \`avatar\` varchar(255) NULL, \`dob\` datetime NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`hach_refresh_token\` varchar(255) NULL, \`roleId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`users_projects\` CHANGE \`id\` \`id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`users_projects\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`users_projects\` ADD PRIMARY KEY (\`id\`, \`user_id\`)`);
        await queryRunner.query(`ALTER TABLE \`users_projects\` CHANGE \`id\` \`id\` int NOT NULL AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`users_projects\` CHANGE \`id\` \`id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`users_projects\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`users_projects\` ADD PRIMARY KEY (\`user_id\`, \`id\`, \`project_id\`)`);
        await queryRunner.query(`ALTER TABLE \`users_projects\` CHANGE \`id\` \`id\` int NOT NULL AUTO_INCREMENT`);
