...
export class Init1678605791942 implements MigrationInterface {
    name = 'Init1678605791942'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`workloads\` DROP COLUMN \`userId\``);
        await queryRunner.query(`ALTER TABLE \`workloads\` ADD \`userId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`vacations\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`vacations\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`vacations\` ADD \`id\` int NOT NULL PRIMARY KEY AUTO_INCREMENT`);
        ...
        await queryRunner.query(`ALTER TABLE \`tasks\` ADD \`id\` int NOT NULL PRIMARY KEY AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`tasks\` DROP COLUMN \`kanbanColumnId\``);
        await queryRunner.query(`ALTER TABLE \`tasks\` ADD \`kanbanColumnId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`kanbans\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`kanbans\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`kanbans\` ADD \`id\` int NOT NULL PRIMARY KEY AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`kanbans\` DROP COLUMN \`projectId\``);
        await queryRunner.query(`ALTER TABLE \`kanbans\` ADD \`projectId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` ADD \`id\` int NOT NULL PRIMARY KEY AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` DROP COLUMN \`kanbanId\``);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` ADD \`kanbanId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD PRIMARY KEY (\`user_id\`)`);
        await queryRunner.query(`DROP INDEX \`IDX_e3d41ac4def7bdaa9ef8d986d1\` ON \`users_vacations\``);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP COLUMN \`vacation_id\``);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD \`vacation_id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD PRIMARY KEY (\`user_id\`, \`vacation_id\`)`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD PRIMARY KEY (\`vacation_id\`)`);
        await queryRunner.query(`DROP INDEX \`IDX_4b06962fad72e30249fa98f689\` ON \`users_vacations\``);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP COLUMN \`user_id\``);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD \`user_id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD PRIMARY KEY (\`vacation_id\`, \`user_id\`)`);
        ...
        await queryRunner.query(`CREATE INDEX \`IDX_e3d41ac4def7bdaa9ef8d986d1\` ON \`users_vacations\` (\`vacation_id\`)`);
        await queryRunner.query(`CREATE INDEX \`IDX_4b06962fad72e30249fa98f689\` ON \`users_vacations\` (\`user_id\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD PRIMARY KEY (\`vacation_id\`)`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP COLUMN \`user_id\``);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD \`user_id\` varchar(36) NOT NULL`);
        await queryRunner.query(`CREATE INDEX \`IDX_4b06962fad72e30249fa98f689\` ON \`users_vacations\` (\`user_id\`)`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD PRIMARY KEY (\`user_id\`, \`vacation_id\`)`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD PRIMARY KEY (\`user_id\`)`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP COLUMN \`vacation_id\``);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD \`vacation_id\` varchar(36) NOT NULL`);
        await queryRunner.query(`CREATE INDEX \`IDX_e3d41ac4def7bdaa9ef8d986d1\` ON \`users_vacations\` (\`vacation_id\`)`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`users_vacations\` ADD PRIMARY KEY (\`user_id\`, \`vacation_id\`)`);
        await queryRunner.query(`ALTER TABLE \`users_kanbans\` DROP PRIMARY KEY`);
        ...
        await queryRunner.query(`ALTER TABLE \`roles_pems\` ADD PRIMARY KEY (\`permission_id\`, \`role_id\`)`);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` DROP COLUMN \`kanbanId\``);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` ADD \`kanbanId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`kanbans\` DROP COLUMN \`projectId\``);
        await queryRunner.query(`ALTER TABLE \`kanbans\` ADD \`projectId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`kanbans\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`kanbans\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`kanbans\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`kanban_columns\` ADD CONSTRAINT \`FK_8fa7b15221b84dc6445ec228f8f\` FOREIGN KEY (\`kanbanId\`) REFERENCES \`kanbans\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`projects\` DROP COLUMN \`id\``);
        ...
        await queryRunner.query(`ALTER TABLE \`tasks\` DROP COLUMN \`kanbanColumnId\``);
        await queryRunner.query(`ALTER TABLE \`tasks\` ADD \`kanbanColumnId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`tasks\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`tasks\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`tasks\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`tasks\` ADD CONSTRAINT \`FK_1bc14b887771ee4d9545d6756c2\` FOREIGN KEY (\`kanbanColumnId\`) REFERENCES \`kanban_columns\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`vacations\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`vacations\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`vacations\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`workloads\` DROP COLUMN \`userId\``);
        await queryRunner.query(`ALTER TABLE \`workloads\` ADD \`userId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`workloads\` ADD CONSTRAINT \`FK_c2a5143516772a26df1cb778883\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`roles\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`roles\` ADD \`id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`roles\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`permissions\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`permissions\` ADD \`id\` varchar(36) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`roles_pems\` ADD CONSTRAINT \`FK_ca161395d6a7e2f10590d9eea48\` FOREIGN KEY (\`permission_id\`) REFERENCES \`permissions\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`roles_pems\` ADD CONSTRAINT \`FK_4df75616161dd63fae14f4f71b9\` FOREIGN KEY (\`role_id\`) REFERENCES \`roles\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }
