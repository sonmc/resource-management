                                ...
                                <Row>
                                    ...
                                    <div className="mt-4">
                                        <div className="hstack gap-2 justify-content-end">
                                            <button type="button" className="btn btn-light" onClick={() => setmodal_board(false)}>
                                                Close
                                            </button>
                                            <button type="button" className="btn btn-success" id="addNewBoard">
                                                Add Board
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div className="modal-body">
                            <Form action="#">
                                <Row className="g-3">
                                    ...
                                    <div className="mt-4">
                                        <div className="hstack gap-2 justify-content-end">
                                            <Button color="light" onClick={() => setmodal_newTask(false)}>
                                                Close
                                            </Button>
