...
const TableContainer = ({ columns, data, isGlobalSearch, isGlobalFilter, isAddOptions, isAddUserList, handleOrderClicks, handleUserClick, handleCustomerClick, isAddCustList, customPageSize, tableClass, theadClass, thClass, divClass }) => {
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
